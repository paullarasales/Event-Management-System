        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                judgeFields.innerHTML = `
                    <div class="flex flex-row w-1/2 gap-5 mb-5">
                        <div class="flex flex-col w-full mx-auto">
                            ...
                            <input type="text" name="username[${judgeIndex}]" placeholder="Add Judge Name" class="outline-none border-white shadow-2xl">
                        </div>
                        <div class="flex flex-col w-full mx-auto">
            ...
            addCriteriaBtn.addEventListener('click', function() {
                ...
                criteriaFields.innerHTML = `
                    <div class="flex flex-col w-full gap-5 mb-5">
                        <div class="flex flex-col w-96">
